...
<?php echo $__env->make('includes.messages', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	<!-- /.box-header -->
	<!-- form start -->
<form method="post" role="form" action="<?php echo e(route('post.update', $post->id)); ?>">
	...
	<input type="text" name="title" value="<?php echo e($post->title); ?>" class="form-control" placeholder="Enter post title here...">
	</div>

	<div class="form-group">
	<label for="subtitle">Sub Title</label>
	<input type="text" name="subtitle" value="<?php echo e($post->subtitle); ?>" class="form-control" placeholder="Enter post title here...">
	</div>

	<div class="form-group">
	<label for="slug">Post Slug</label>
	<input type="text" name="slug" value="<?php echo e($post->slug); ?>" class="form-control" placeholder="Enter post title here...">
	</div>	
 ...
 <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>     
  ...
  <div class="form-group" style="margin-top: 18px;">
   ...
   <select class="form-control select2" multiple="multiple" data-placeholder="Select a Category"
	...
	font-size: 14px;" name="body" class="form-control" id="editor1"><?php echo $post->body; ?></textarea>
</div>
	<div class="box-footer">
