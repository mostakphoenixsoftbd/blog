...
<td><a href="<?php echo e(route('category.edit', $category->id)); ?>"><i class="fa fa-fw fa-edit"></i></a></td>
...
{
event.preventDefault();document.getElementById('delete-form-<?php echo e($category->id); ?>').submit();
}
else
{
